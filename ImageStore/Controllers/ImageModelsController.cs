...
namespace ImageStore.Controllers
{
    public class ImageModelsController : Controller
    {
        ...
        public ImageModelsController(ImageDbContext context, IWebHostEnvironment env)
        {
            _context = context;
            this.env = env;
        }
        ...
        public async Task<IActionResult> Create([Bind("ImageId,Title,ImageFile,ImageName")] ImageModel imageModel)
        {
            if (ModelState.IsValid)
            {
                ...
                using (FileStream fs = new(path, FileMode.Create)){
                    await imageModel.ImageFile.CopyToAsync(fs);
                }
